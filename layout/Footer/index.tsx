function Footer() {
	return (
		<footer className='flex flex-col items-center justify-around h-60 mt-20 lg:flex-row bg-footer-color text-white'>
			<p className='text-3xl font-bold text-center sm:text-left'>Blog feito por Matheus Pergoli.</p>
